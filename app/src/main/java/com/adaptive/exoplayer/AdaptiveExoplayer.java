...
//    public static final String DOWNLOAD_NOTIFICATION_CHANNEL_ID = "lakhya_online_download_channel";
    ...
    public void onCreate() {
        ...
        videoModels.add(new VideoModel("1","Resignation",video_url,15));
        videoModels.add(new VideoModel("2","big buck bunny",video_url,128));
        videoModels.add(new VideoModel("3","example",video_url,30));
